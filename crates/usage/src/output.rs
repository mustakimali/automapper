        ...
        pub mod mod_1733172599223_5b51vh4epshvy8 {
            fn __map(value : crate :: models :: SourceStruct) -> crate :: models ::
DestStruct
{ crate :: models :: DestStruct { a : value.a, b : value.b, s : value.s, } }
        }

        pub mod mod_1733172599223_hh9t6039ppv2v3 {
            fn __map(value : crate :: models :: SourceStruct) -> crate :: models ::
DestStruct
{ crate :: models :: DestStruct { a : value.a, b : value.b, s : value.s, } }
        }

        pub mod mod_1733172599291_ybzw4h0212azd9 {
...
DestStruct2
{
    crate :: models :: DestStruct2
    {
        ...
        pub mod mod_1733172599292_rc5erxxwv9na5h {
            fn __map(value : crate :: models :: SourceStruct2) -> crate :: models ::
DestStruct2
{
    crate :: models :: DestStruct2
    {
        ...
        pub mod mod_1733172599365_8arjx53bmsrvkb {
...
DestStruct4
{
    crate :: models :: DestStruct4
    {
        ...
        pub mod mod_1733172599366_kb6qtey9be7z4e {
            fn __map(value : crate :: models :: SourceStruct3) -> crate :: models ::
DestStruct4
{
    crate :: models :: DestStruct4
    {
        ...
        pub mod mod_1733172599435_fd7xfsccvzm8e7 {
...
:: DestStructWithEnum
{
    crate :: models :: DestStructWithEnum
    {
        ...
        pub mod mod_1733172599447_4qmraynffgdqz8 {
            fn __map(value : crate :: models :: SourceStructWithEnum) -> crate :: models
:: DestStructWithEnum
{
    crate :: models :: DestStructWithEnum
    {
        ...
        pub mod mod_1733172599504_k3frahq9nr4hcm {
...
:: protogen :: example :: HomoSepiens
{
    crate :: protogen :: example :: HomoSepiens
    {
        ...
        pub mod mod_1733172599523_egdck85skrjbxn {
            fn map_proto_struct(value : crate :: protogen :: example :: Person) -> crate
:: protogen :: example :: HomoSepiens
{
    crate :: protogen :: example :: HomoSepiens
